#region 程序集 Logrila.Logging.dll, v1.0.3.0
// E:\研究生\AGVs\程序2\下载\Cowboy-master\Cowboy-master\Cowboy\packages\Logrila.Logging.1.0.3.0\lib\net46\Logrila.Logging.dll
#endregion
using System;
using System.IO;
using System.Net;
    ...
    public sealed class TcpSocketSession
    {
            ...
            var validateRemoteCertificate = new RemoteCertificateValidationCallback(
                ...
                =>
                {
                    ...
                    if (_configuration.SslPolicyErrorsBypassed)
                        ...
                        Logs.Error(string.Format("Session [{0}] error occurred when validating remote certificate: [{1}], [{2}].",
        ...
        private void HandleDataReceived(IAsyncResult ar)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Logs.Error(innnerException.Message, innnerException);
                }
            }
        }
        ...
        {
            Logs.Error(string.Format("Session [{0}] error occurred in user side [{1}].", this, ex.Message), ex);
        }
